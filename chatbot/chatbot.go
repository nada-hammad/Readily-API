...
func AuthorInfo(w http.ResponseWriter, r *http.Request) {


info := controller.GetAuthorInfoById("18541", "mpTE2wR5Fx0T3GjYwHpug")
	fmt.Println(info)
}
...
func Engage(addr string) error {
	...
	mux.HandleFunc("/AuthorInfo", withLog(AuthorInfo))
